 ...
 *
 * Mensaje 1: solicitarDashboard()
 *   → useEffect al cargar el componente
 *
 * Mensaje 1.1: cargarIndicadores(gestion: 2026)
 *   → GET /api/dashboard/estadisticas
 *
 * Mensaje 1.3: [indicadores: inscritos=1001, grupos=15]
 *   → setEstadisticas(data)
 *
 * Mensaje 1.4: mostrarDashboard()
 *   → Render de tarjetas con estadísticas en tiempo real
 *
 * FLUJO 2: Los reportes CSV/PDF se generan en los módulos
 * individuales (Postulantes, Docentes, Examenes, Grupos)
 * usando jsPDF + autoTable directamente en el frontend.
 */
                ...
                <nav className="dash-navbar">
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <div>
                            ...
                            <div className="d-none d-md-block" style={{ color: 'rgba(255,255,255,0.65)', fontSize: '0.68rem', letterSpacing: '0.3px' }}>
