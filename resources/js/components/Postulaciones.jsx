 ...
 * Mensaje 1: registrarPostulacion() → handleSubmit()
 * Mensaje 1.2: verificarCuposOpcion1() → POST /api/postulaciones
 * Mensaje 1.8: actualizarEstadoAdmision() → PUT estado
 * Mensaje 1.10: mostrarEstadoAdmision() → render tabla
 */
