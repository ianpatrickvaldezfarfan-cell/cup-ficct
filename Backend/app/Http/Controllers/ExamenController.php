 ...
 *
 * 1.7: calcularPromedio((nota1+nota2+nota3)/3) → GENERATED en PostgreSQL
 ...
 * 2.1: obtenerNotasPorCI(ci) → 2.4: mostrarCalificaciones()
 *
 ...
 * Regla: nota_final = (nota1+nota2+nota3)/3 (GENERATED en PostgreSQL)
 * Si TODAS >= 60 → APROBADO | Si CUALQUIER < 60 → REPROBADO
 */
