 ...
 * ALT [individual]: 1.5 CRUD | ALT [CSV]: 1.7 procesarArchivoCSV → 1.9 guardarUsuarios
 * 1.11: mostrarResultado(cuentas creadas/errores detectados)
 *
 * Controlador de gestion de usuarios y roles (CU7).
 * Administra las cuentas de acceso del sistema. Soporta CRUD individual,
 * activacion/desactivacion y carga masiva desde CSV.
