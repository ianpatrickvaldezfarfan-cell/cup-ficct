 ...
 *
 * 1.2: almacenarArchivo(archivo) | ALT [formato invalido]: 1.6 retornarError
 * 1.3: [urlArchivo] | ALT [tamano excedido]: 1.7 retornarError
 ...
 *           → «E» Pagos → «E» Usuarios
 *
 * 1.4: registrarPago(postulacion_id, concepto, monto: Bs.700, COMPLETADO)
 ...
 * - paso1:  Datos personales + cupos + postulacion(PENDIENTE_PAGO)
 * - paso1b: Subida de documentos al storage del servidor
 * - paso2:  Confirmacion de pago + creacion de usuario + credenciales
 */
