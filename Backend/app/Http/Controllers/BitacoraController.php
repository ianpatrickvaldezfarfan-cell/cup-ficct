 ...
 *
 * 1.1: procesarConsulta(filtros) → 1.2: buscarRegistros(usuario_id, accion, tabla, fecha)
 * 1.3: [listaRegistrosBitacora] → 1.4: mostrarHistorial(usuario, accion, descripcion, ip)
 *
 ...
 * Los registros son creados automaticamente por BitacoraService.
 */
